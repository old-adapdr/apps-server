...
docker-compose -f $ROOT_DIR/ward/ward.yaml down
...
rm \
$ROOT_DIR/main.yaml \
$ROOT_DIR/whoami/whoami.yaml \
$ROOT_DIR/traefik/traefik.yaml \
$ROOT_DIR/ward/ward.yaml
...
cp $ROOT_DIR/ward/dist.ward.yaml $ROOT_DIR/ward/ward.yaml
...
docker-compose -f $ROOT_DIR/ward/ward.yaml up -d
